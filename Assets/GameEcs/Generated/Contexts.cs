...
public partial class Contexts {
    ...
    public void InitializeEntityIndices() {
        game.AddEntityIndex(new Entitas.EntityIndex<GameEntity, float>(
            Timer,
            game.GetGroup(GameMatcher.Timer),
            (e, c) => ((TimerComponent)c).Value));
    }
}

public static class ContextsExtensions {

    public static System.Collections.Generic.HashSet<GameEntity> GetEntitiesWithTimer(this GameContext context, float Value) {
        return ((Entitas.EntityIndex<GameEntity, float>)context.GetEntityIndex(Contexts.Timer)).GetEntities(Value);
    }
}
//------------------------------------------------------------------------------
// <auto-generated>
