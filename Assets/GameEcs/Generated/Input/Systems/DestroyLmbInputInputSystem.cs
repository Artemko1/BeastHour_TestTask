...
public sealed class DestroyLmbInputInputSystem : ICleanupSystem {

    readonly IGroup<InputEntity> _group;
    readonly List<InputEntity> _buffer = new List<InputEntity>();

    public DestroyLmbInputInputSystem(Contexts contexts) {
        _group = contexts.input.GetGroup(InputMatcher.LmbInput);
    }
